...
if result_json:
    ...
    df, producto_id, fecha_inicio, pasos, frecuencia, device, features, scaler_x, scaler_y,seq_len = entrenar(features, scaler_x, scaler_y, X_train_tensor, y_train_tensor, X_test_tensor, y_test_tensor, device, df,seq_len,producto_id )
    
    predecir_futuro_producto(df,producto_id, fecha_inicio, pasos, frecuencia, device, features, scaler_x, scaler_y,seq_len)
